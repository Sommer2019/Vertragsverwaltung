...
public class CreateTest {
    ...
    @BeforeEach
    void setUp() {
        // Konfiguriere hier z. B. den Rückgabewert für repository.ladeFaktoren()
    ...
    public void testCreateVertragAndSave() {
        ...
        VertragService spyService = spy(vertragService);
        doReturn(stubPreis)
                .when(spyService)
        ...
        double resultPreis = spyService.createVertragAndSave(inputVertrag, monatlich, vsnr);
